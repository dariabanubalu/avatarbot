...
FRAMES = [
    {"id": "1", "name": "Амбассадор",     "file": "frames/2_ambassador.png"},
    {"id": "2", "name": "Участница",      "file": "frames/3_uchastnitsa.png"},
    {"id": "3", "name": "Лауреат премии", "file": "frames/1_laureat.png"},
]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Добавь фирменную рамку к аватарке — отправь своё фото, "
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 2 кнопки в первом ряду, 1 широкая во втором
    keyboard = [
        [
            InlineKeyboardButton("1. Амбассадор", callback_data="frame_1"),
            InlineKeyboardButton("2. Участница", callback_data="frame_2"),
        ],
        [
            InlineKeyboardButton("3. Лауреат премии", callback_data="frame_3"),
        ],
    ]
